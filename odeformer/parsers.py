...
def get_parser():
    ...
    parser.add_argument("--save_periodic",type=int,default=10,help="Save the model periodically (0 to disable)",) #ADAPTED
    ...
    parser.add_argument(
        "--enc_emb_dim", type=int, default=128, help="Encoder embedding layer size"
    ) # adapt
    parser.add_argument(
        "--dec_emb_dim", type=int, default=128, help="Decoder embedding layer size"
    ) # adapt
    parser.add_argument(
    ...
    parser.add_argument(
        "--test_env_seed", type=int, default=11, help="Test seed for environments"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--max_epoch", type=int, default=25000, help="Number of epochs"
    ) #ADAPTED
    parser.add_argument(
        "--stopping_criterion",
        type=str,
    ...
    parser.add_argument(
        "--train_path",
        type=str,
        default="data/data_nlode_explicit_odeformer_train.h5",
    ...
    parser.add_argument(
        "--test_path",
        type=str,
        default="data/data_nlode_explicit_odeformer_test.h5",
        help="Load dataset from the disk (task1,train_path1,valid_path1,test_path1;task2,train_path2,valid_path2,test_path2)",
    )
    parser.add_argument(
        "--reload_data",
    ...
    parser.add_argument("--eval_on_pmlb", type=bool_flag, default=False)
    parser.add_argument("--eval_in_domain", type=bool_flag, default=True)
    parser.add_argument("--rescale", type=bool_flag, default=True, help="Whether to rescale at inference.") #ADAPTED
    ...
    parser.add_argument("--cpu", type=bool_flag, default=True, help="Run on CPU")
    parser.add_argument(
